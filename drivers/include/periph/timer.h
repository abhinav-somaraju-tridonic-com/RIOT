 ...
 * @brief       Low-level timer periphial driver
 * @{
 *
 * @file        timer.h
 * @brief       Low-level timer periphial driver interface definitions
 *
 ...
 * as definded in periph_conf.h. The timer is configured in up-counting mode and will count
 ...
 * @param channel       the cannel on the given device to clear
 * @return              1 on success, -1 on error
 */
...
/**
 * @brief Reset the upcounting value to zero for the given timer
 * 
