/*
 * AES.c - The AES.c Cipher-Algorithm.
 *
...
{
    return AES_init(context, AES_info_get_preferred_block_size(), keysize, key);
}
...
uint8_t AES_info_get_preferred_block_size()
{
