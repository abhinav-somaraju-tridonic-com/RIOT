 ...
 */
int three_des_init(cipher_context_t *context, uint8_t blockSize, uint8_t keySize,
                   uint8_t *key);
 ...
 */
int three_des_setup_key(cipher_context_t *context, uint8_t *key, uint8_t keysize);
 ...
 */
int three_des_encrypt(cipher_context_t *context, uint8_t *plain, uint8_t *crypt);
 ...
 */
int three_des_decrypt(cipher_context_t *context, uint8_t *crypt, uint8_t *plain);

/**
 * @brief returns the blocksize of the 3DES algorithm
 */
uint8_t three_des_get_preferred_block_size(void);

/**
  * Interface to access the functions
  *
  */
block_cipher_interface_t ThreeDESInterface = {
    "3DES\0",
    three_des_init,
    three_des_encrypt,
    three_des_decrypt,
    three_des_setup_key,
    three_des_get_preferred_block_size
};
