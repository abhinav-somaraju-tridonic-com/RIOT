/*
 * AES.h - The Headers for the AES Cipher-Algorithm.
 *
 ...
 */
uint8_t AES_info_get_preferred_block_size(void);

/**
  * Interface to access the functions
  *
  */
block_cipher_interface_t AESInterface = {
    "AES\0",
    AES_init,
    AES_encrypt,
    AES_decrypt,
    AES_setup_key,
    AES_info_get_preferred_block_size
};
